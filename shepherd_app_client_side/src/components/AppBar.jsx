...
function progressCircle(progressCircleState) {

  switch (progressCircleState) {
    case 'success':
      return <Typography>Success!</Typography>
    case 'progress':
      return <Fade
        in={progressCircleState === 'progress'}
        style={{
          transitionDelay: progressCircleState === 'progress' ? '800ms' : '0ms',
        }}
        unmountOnExit
      >
        <CircularProgress
...
export default function CustomAppBar(props) {
  ...
  // const progressCircleState = React.useContext(progressCircleContext)
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static">
        <Toolbar>
          <IconButton onClick={props.drawerOpener}
            size="large"
            edge="start"
            color="inherit"
          ...
          >
            { /*to make the page name always visible*/}
            {props.title}
          </Typography>
          <Box sx={{ flexGrow: 1 }} />
